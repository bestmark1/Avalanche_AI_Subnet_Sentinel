...
export class InMemoryStateStore implements IStateStore {
  private snapshot: SubnetSnapshot | null = null;
   ...
   */
  public updateSnapshot(snapshot: SubnetSnapshot): void {
   ...
   */
  public getCurrentSnapshot(): SubnetSnapshot | null {
   ...
   */
  public setLastAnalysis(analysis: AnalysisResult): void {
   ...
   */
  public getLatestState(): StateSnapshot {
    return {
